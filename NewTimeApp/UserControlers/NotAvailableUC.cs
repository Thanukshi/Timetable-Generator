...
namespace NewTimeApp.UserControlers
{
    public partial class NotAvailableUC : UserControl
    {
        ...
        private void notAvailablePanel_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void subgNota_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void mainGNotA_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void TagNotA_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void timeNotA_TextChanged(object sender, EventArgs e)
        {

        }

        private void SubNotA_SelectedIndexChanged(object sender, EventArgs e)
        {

        }

        private void LecNotA_SelectedIndexChanged(object sender, EventArgs e)
        {
