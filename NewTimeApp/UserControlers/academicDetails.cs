...
namespace NewTimeApp.UserControlers
{
    public partial class academicDetails : UserControl
    {
        ...
        "buildingcb VARCHAR (50) NOT NULL,categorycb VARCHAR (50) NOT NULL,levelcb VARCHAR (50) NOT NULL,ranktb VARCHAR (50) NOT NULL)";
                ...
                //string sql12 = "CREATE TABLE notAvailable (ID INTEGER PRIMARY KEY ASC AUTOINCREMENT, time VARCHAR (50) NOT NULL, lecName VARCHAR (100) NOT NULL, subName VARCHAR (50) NOT NULL, tag VARCHAR (50) NOT NULL, mg VARCHAR (50) NOT NUL, sg VARCHAR (50) NOT NUL )";
